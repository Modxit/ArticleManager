...
<td class="small">[+Store+]</td><td class="small">[+ProdottoInOfferta+]</td>
<td class="small">[+topShop+]</td><td class="small">[+Prezzo+] €</td>
...
<td class="bg-danger" width="5%"><a class="btn btn-sm btn-danger" href="index.php?a=6&id=[+id+]" title="delete"><i class="fa fa-trash-o"></i> Delete</a></td></tr>';
